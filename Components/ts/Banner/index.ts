...
//     <a href="./pages/cursos.html" class="hero-banner__button">Explore Nossos Cursos</a>
// </section>
...
if (banner) new Banner().create(banner, info.title, info.desc, { href: info.button.href, content: info.button.content });
